...
export function AsphaltCompare() {
  ...
  const before = useMedia("compare_before", excavation);
  const after = useMedia("compare_after", road);
  ...
  return (
    <section className="relative bg-asphalt py-32 md:py-44">
      <div className="mx-auto max-w-[1600px] px-6 lg:px-12">
        ...
        >
          <img src={before} alt="До" className="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async" />
          <div className="absolute inset-0 overflow-hidden" style={{ width: `${pos}%` }}>
            <img src={after} alt="После" className="absolute inset-0 h-full w-[100vw] object-cover" loading="lazy" decoding="async" style={{ minWidth: "100%" }} />
          </div>
