...
export function MachineryShowcase() {
  ...
  const m1 = useMedia("machinery_image_1", truck);
  const m2 = useMedia("machinery_image_2", excavator);
  const m3 = useMedia("machinery_image_3", paver);
  const fleet = [
    { id: "truck", name: "Самосвалы", model: "10–25 т", img: m1, specs: ["Объём 12 м³", "Грузоподъёмность 25 т", "До 6 единиц"] },
    { id: "exc", name: "Экскаватор-погрузчик", model: "JCB 4CX", img: m2, specs: ["Глубина копания 6 м", "Ковш 1 м³", "Опытный оператор"] },
    { id: "paver", name: "Асфальтоукладчик", model: "Vögele Super", img: m3, specs: ["Ширина 2.5–6 м", "Авто-нивелир", "Точный слой"] },
