...
const KNOWN_FIELDS: { key: string; label: string; type?: "text" | "textarea" }[] = [
  ...
  { key: "telegram", label: "Telegram (@username или username)" },
  { key: "whatsapp", label: "WhatsApp (номер в формате +7XXXXXXXXXX)" },
  { key: "max_messenger", label: "VK Max / VK Messenger (username)" },
