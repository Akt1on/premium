...
import { LayoutDashboard, Wrench, Inbox, Settings, Building2, LogOut, Shield, Loader2, Image as ImageIcon } from "lucide-react";
...
function AdminShell() {
  ...
  const nav = [
    ...
    { to: "/admin/media", label: "Медиа", icon: ImageIcon, exact: false },
